<template>
    ...
    <div
        class="form__images w-96 flex flex-wrap gap-2"
        :class="{
			_sending: isReadOnly,
    ...
    >
        <div
            ...
            class="image__input image-input"
            :class="{
        ...
        >
            ...
            >
                ...
                <div class="image-input__placeholder image-input-placeholder">
                    <div class="image-input-placeholder__icon">
                        <svg
                            viewBox="0 0 48 48"
                            xmlns="http://www.w3.org/2000/svg"
                        >
                    ...
                    <div class="image-input-placeholder__title">Добавьте фото</div>
                </div>
                <button
                    v-if="index !== 0 && !currentItem"
                    :disabled="isReadOnly"
                    type="button"
                    class="image-input__move image-input__move-current"
                ...
                <button
                    ...
                    type="button"
                    class="image-input__move image-input__move-target"
                >
                    Сюда
                </button>
            </div>
